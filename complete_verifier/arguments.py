...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--patch_sz", type=int, default=None,
                          help='Patch size for Lp norm verification.',
                          hierarchy=h + ["patch_sz"])
        self.add_argument("--in_channels", type=int, default=1,
                          help='Number of channels in input image.',
                          hierarchy=h + ["in_channels"])
