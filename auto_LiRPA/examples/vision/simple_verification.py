...
lirpa_model = BoundedModule(model, torch.empty_like(image), bound_opts={"conv_mode": "matrix"}, device=image.device)
...
# norm = float("inf")
norm = 2
# ptb = PerturbationMyNorm(patch_sz=3, norm = norm, eps = eps)
